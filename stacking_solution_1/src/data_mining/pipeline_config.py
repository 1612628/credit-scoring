...
SOLUTION_CONFIG = AttrDict({
    ...
    'tuner': {
        'LightGBM':{
                'LightGBM__boosting_type': param_eval(params.tuning_lgbm__boosting_type),
                'LightGBM__objective': param_eval(params.tuning_lgbm__objective),
                'LightGBM__metric': param_eval(params.tuning_lgbm__metric),
                'LightGBM__number_boosting_rounds': param_eval(params.tuning_lgbm__number_boosting_rounds),
                'LightGBM__early_stopping_rounds': param_eval(params.tuning_lgbm__early_stopping_rounds),
                'LightGBM__learning_rate': param_eval(params.tuning_lgbm__learning_rate),
                'LightGBM__max_bin': param_eval(params.tuning_lgbm__max_bin),
                'LightGBM__max_depth': param_eval(params.tuning_lgbm__max_depth),
                'LightGBM__num_leaves': param_eval(params.tuning_lgbm__num_leaves),
                'LightGBM__min_data_in_leaf': param_eval(params.tuning_lgbm__min_data_in_leaf),
                'LightGBM__bagging_fraction': param_eval(params.tuning_lgbm__bagging_fraction),
                'LightGBM__bagging_freq': param_eval(params.tuning_lgbm__bagging_freq),
                'LightGBM__feature_fraction': param_eval(params.tuning_lgbm__feature_fraction),
                'LightGBM__min_gain_to_split': param_eval(params.tuning_lgbm__min_gain_to_split),
                'LightGBM__lambda_l1': param_eval(params.tuning_lgbm__lambda_l1),
                'LightGBM__lambda_l2': param_eval(params.tuning_lgbm__lambda_l2),
                'LightGBM__is_unbalanced': param_eval(params.tuning_lgbm__is_unbalanced),
                'LightGBM__scale_pos_weight': param_eval(params.tuning_lgbm__scale_pos_weight),
            },
        'CatBoost': {
